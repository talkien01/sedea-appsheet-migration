// Modulo de Reportes (Beta): catalogos de filtros + el reporte en JSON.
// La exportacion a Excel se resuelve aparte con `urlConToken` (cliente.ts),
// igual que el PDF de solicitud-completa -- es una descarga de archivo, no
// una respuesta JSON.
import { peticion } from './cliente';
import type { DimensionReporte, FiltrosReporte, RespuestaReporte } from '@sedea/shared';
...
export function armarQueryReporte(filtros: Partial<FiltrosReporte> & { agrupar_por: DimensionReporte }): string {
